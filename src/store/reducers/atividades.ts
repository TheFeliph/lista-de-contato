...
const initialState: AtividadeState = {
  itens: [
    {
      id: 1,
      nomeContato: 'Leticia Mattos',
      emailContato: 'ph@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 2,
      nomeContato: 'Felipe Nascimento',
      emailContato: 'fnacsi@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 3,
      nomeContato: 'José Aparecido',
      emailContato: 'jvsss@hotmail.com',
      phoneContato: '(99)99999-9999'
    },
    {
      id: 4,
      nomeContato: 'Leticia Nascimento',
      emailContato: 'letttnsc@outlook.com.br',
      phoneContato: '(99)99999-9999'
    }
  ]
}
